 ...
 * Skips: null, primitive types, and complex expressions.
 */
function extractFieldName(
  ...
  const primitives = ['String', 'Integer', 'Double', 'Float', 'Long', 'Boolean', 'Date', 'Object', 'void'];
  ...
  if (typeAndName) {
    ...
    // Return the type name for types like TcbsJWT (but not primitives)
