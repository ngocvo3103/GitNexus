 ...
 */
function extractClassFields(node: Parser.SyntaxNode, language: SupportedLanguages): FieldInfo[] {
  ...
  for (const file of files) {
    ...
    for (const match of matches) {
      ...
      if (nodeLabel === 'Function' || nodeLabel === 'Method' || nodeLabel === 'Constructor') {
        ...
        // Store detailed parameter info (name, type, annotations) for Java/Kotlin
