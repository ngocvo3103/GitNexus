...
program
  ...
  .option('--openapi', 'Write both JSON and OpenAPI 3.1.0 YAML spec to --outputPath', false)
  .option('--outputPath <path>', 'Output directory for JSON and OpenAPI YAML files (required with --openapi)')
